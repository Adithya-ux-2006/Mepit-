...
import { getRateLimitStatus, getUserProjects, updateProjectStatus } from '@/lib/api';
...
export function DashboardClient({ initialData }: { initialData: DashboardData }) {
  ...
  const formulaCount = initialData.formulas.length;
  ...
  const [myProjects, setMyProjects] = useState<Project[]>(() =>
    user?.id ? initialData.projects.filter((project) => project.submitted_by === user.id) : [],
  );
  const formulas = initialData.formulas;
